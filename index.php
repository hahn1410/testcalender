	...
	<body>
		...
		<div class="main">
			...
			<div class="fullcal">
				...
				<p>On march 25, 2015, Hahn Zulkifli started his YouTube video log, so I decided to code this page using YouTube’s API, if you want to know more about this or me, go to the page bottom.</p>

				<div class="cal"></div>


				<p id="about"><strong>About this:</strong> YouTube/Google provide different APIs and you can do any kind of crazy stuff with them, like getting the complete uploads video playlist from any YouTube user, but that is half of work, then you have to present the data in a way it is pleasant to view, I tried many libraries already available online, but none did what I wanted, I tried a time-line, many calendars, but nothing, so following Casey’s philosophy, I keep it as simple as it can be.</p>
				<p><strong>About me:</strong> My Name is Hahn Zulkifli, a self-taught storyteller and filmaker with over 10 years of experience, currently working on two incredible projects, looking for <a href="https://linktr.ee/hahnzulkifli">investors</a> for a third project. my Twitter profile in <a href="https://twitter.com/Hahnzulkifli">English</a> , my YouTube channel in  <a href="http://www.youtube.com/c/hahnzulkifli">English</a>,  and my <a href="https://www.instagram.com/hahnzulkifli">Instagram</a> profile.</p>
